...
YES_LIST="LEGACY_VSYSCALL_NONE FB_SIMPLE NTFS_RW TRIM_UNUSED_KSYMS X86_P6_NOP KERNEL_LZ4 IO_DELAY_NONE MNATIVE OPTIMIZE_INLINING NLS_ASCII NLS_CODEPAGE_437 NLS_UTF8 HZ_300"
